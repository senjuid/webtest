...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs */ 6587);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! rxjs */ 6439);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! rxjs */ 4483);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! rxjs */ 2218);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! rxjs/operators */ 2160);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! rxjs/operators */ 8331);
...
function noMatch(segmentGroup) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.throwError)(new NoMatch$1(segmentGroup));
}

function absoluteRedirect(newTree) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.throwError)(new AbsoluteRedirect(newTree));
}

function namedOutletsRedirect(redirectTo) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.throwError)(new Error(`Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}

function canLoadFails(route) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.throwError)(navigationCancelingError(`Cannot load children because the guard of the route "path: '${route.path}'" returned false`));
}
/**
...
function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
  ...
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(keys).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(key => getResolver(resolve[key], futureARS, futureRSS, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.tap)(value => {
    data[key] = value;
  }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_23__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.mergeMap)(() => {
...
class RouterConfigLoader {
  ...
  load(parentInjector, route) {
    ...
    route._loader$ = new rxjs__WEBPACK_IMPORTED_MODULE_25__.ConnectableObservable(loadRunner, () => new rxjs__WEBPACK_IMPORTED_MODULE_26__.Subject()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_27__.refCount)());
    return route._loader$;
  }
...
class Router {
  ...
  constructor(rootComponentType, urlSerializer, rootContexts, location, injector, compiler, config) {
    ...
    this.events = new rxjs__WEBPACK_IMPORTED_MODULE_26__.Subject();
    /**
...
class RouterLink {
  constructor(router, route, tabIndexAttribute, renderer, el) {
    ...
    this.onChanges = new rxjs__WEBPACK_IMPORTED_MODULE_26__.Subject();
...
class RouterLinkActive {
  ...
  ngAfterContentInit() {
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(this.links.changes, this.linksWithHrefs.changes, (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(null)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_29__.mergeAll)()).subscribe(_ => {
      this.update();
  ...
  subscribeToEachLinkOnChanges() {
    ...
    this.linkInputChangesSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(allLinkChanges).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_29__.mergeAll)()).subscribe(link => {
...
class RouterPreloader {
  ...
  processRoutes(ngModule, routes) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(res).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_29__.mergeAll)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(_ => void 0));
  }
...
class RouterInitializer {
  constructor(injector) {
    ...
    this.resultOfPreactivationDone = new rxjs__WEBPACK_IMPORTED_MODULE_26__.Subject();
  }
